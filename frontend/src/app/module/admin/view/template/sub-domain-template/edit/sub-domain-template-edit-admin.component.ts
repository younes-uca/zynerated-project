...
@Component({
  selector: 'app-sub-domain-template-edit-admin',
  templateUrl: './sub-domain-template-edit-admin.component.html'
})
export class SubDomainTemplateEditAdminComponent extends AbstractEditController<SubDomainTemplateDto, SubDomainTemplateCriteria, SubDomainTemplateAdminService>   implements OnInit {
