...
export class DomainTemplateEditAdminComponent extends AbstractEditController<DomainTemplateDto, DomainTemplateCriteria, DomainTemplateAdminService>   implements OnInit {
