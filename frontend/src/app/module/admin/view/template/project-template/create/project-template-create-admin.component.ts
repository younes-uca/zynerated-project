...
@Component({
  selector: 'app-project-template-create-admin',
  templateUrl: './project-template-create-admin.component.html'
})
export class ProjectTemplateCreateAdminComponent extends AbstractCreateController<ProjectTemplateDto, ProjectTemplateCriteria, ProjectTemplateAdminService>  implements OnInit {
   ...
   private _validProjectTemplateCode = true;
    ...
    const isPermistted = await this.roleService.isPermitted('SubDomainTemplate', 'add');
    if(isPermistted) {
         this.subDomainTemplate = new SubDomainTemplateDto();
    ...
    const isPermistted = await this.roleService.isPermitted('CategoryProjectTemplate', 'add');
    if(isPermistted) {
         this.categoryProjectTemplate = new CategoryProjectTemplateDto();
