...
export class InscriptionCollaboratorCreateAdminComponent extends AbstractCreateController<InscriptionCollaboratorDto, InscriptionCollaboratorCriteria, InscriptionCollaboratorAdminService>  implements OnInit {
    ...
    const isPermistted = await this.roleService.isPermitted('InscriptionState', 'add');
    if(isPermistted) {
         this.inscriptionState = new InscriptionStateDto();
