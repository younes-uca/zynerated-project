...
@Component({
  selector: 'app-inscription-state-create-admin',
  templateUrl: './inscription-state-create-admin.component.html'
})
export class InscriptionStateCreateAdminComponent extends AbstractCreateController<InscriptionStateDto, InscriptionStateCriteria, InscriptionStateAdminService>  implements OnInit {
