...
export class CouponEditAdminComponent extends AbstractEditController<CouponDto, CouponCriteria, CouponAdminService>   implements OnInit {
    ...
    public override prepareEdit() {
        this.item.dateDebut = this.couponService.format(this.item.dateDebut);
        this.item.dateFin = this.couponService.format(this.item.dateFin);
    }
