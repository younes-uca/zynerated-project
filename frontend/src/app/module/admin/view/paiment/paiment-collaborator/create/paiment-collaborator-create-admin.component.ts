...
export class PaimentCollaboratorCreateAdminComponent extends AbstractCreateController<PaimentCollaboratorDto, PaimentCollaboratorCriteria, PaimentCollaboratorAdminService>  implements OnInit {
