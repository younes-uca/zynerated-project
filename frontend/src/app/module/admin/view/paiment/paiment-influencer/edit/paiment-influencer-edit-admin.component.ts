...
export class PaimentInfluencerEditAdminComponent extends AbstractEditController<PaimentInfluencerDto, PaimentInfluencerCriteria, PaimentInfluencerAdminService>   implements OnInit {
    ...
    public override prepareEdit() {
        this.item.datePaiement = this.paimentInfluencerService.format(this.item.datePaiement);
    }
