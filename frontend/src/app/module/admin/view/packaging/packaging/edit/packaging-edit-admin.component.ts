...
export class PackagingEditAdminComponent extends AbstractEditController<PackagingDto, PackagingCriteria, PackagingAdminService>   implements OnInit {
    ...
    public override prepareEdit() {
        this.item.dateDebut = this.packagingService.format(this.item.dateDebut);
        this.item.dateFin = this.packagingService.format(this.item.dateFin);
    }
